...
export const tools = [
  {
    ...
    description: "Search for restaurants with optional filters. Can search by text query, location, cuisine type, date range, party size, budget, and more.  Returns restaurant objects with fields like : name, search image (a preview image), images, budget averages, availability (array of dates), a slug, etc.",
    inputSchema: {
      type: "object",
      properties: {
        query: {
